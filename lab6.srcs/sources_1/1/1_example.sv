...
logic [0:0] rom_q_one, rom_q_two, rom_q_three, rom_q_four, rom_q_five, rom_q_six, rom_q_seven, rom_q_eight, rom_q_nine, rom_q_score, rom_q_zero;
...
always_comb begin
    ...
    if(DrawX >= 600 && DrawX < 616 && DrawY >= 200 && DrawY < 232 ) begin
        rom_address = (DrawY-200)*16 + (DrawX-600);
		case (score1_ten)
			...
			4'b0101: palette_rom = rom_q_five;
			4'b0110: palette_rom = rom_q_six;
			4'b0111: palette_rom = rom_q_seven;
			4'b1000: palette_rom = rom_q_eight;
			4'b1001: palette_rom = rom_q_nine;
		endcase
    end
