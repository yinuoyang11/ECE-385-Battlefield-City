...
# IP: ip/frame_buffer_0/frame_buffer_0.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==frame_buffer_0 || ORIG_REF_NAME==frame_buffer_0} -quiet] -quiet
