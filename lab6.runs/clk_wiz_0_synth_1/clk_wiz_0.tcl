...
namespace eval ::optrace {
  variable script "E:/xilinx/lab6/lab6.runs/clk_wiz_0_synth_1/clk_wiz_0.tcl"
...
set cacheID [config_ip_cache -export -no_bom  -dir E:/xilinx/lab6/lab6.runs/clk_wiz_0_synth_1 -new_name clk_wiz_0 -ip [get_ips clk_wiz_0]]
...
if { [catch {
  file copy -force E:/xilinx/lab6/lab6.runs/clk_wiz_0_synth_1/clk_wiz_0.dcp e:/xilinx/lab6/lab6.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub e:/xilinx/lab6/lab6.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub e:/xilinx/lab6/lab6.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim e:/xilinx/lab6/lab6.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim e:/xilinx/lab6/lab6.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force E:/xilinx/lab6/lab6.runs/clk_wiz_0_synth_1/clk_wiz_0_stub.v e:/xilinx/lab6/lab6.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force E:/xilinx/lab6/lab6.runs/clk_wiz_0_synth_1/clk_wiz_0_stub.vhdl e:/xilinx/lab6/lab6.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force E:/xilinx/lab6/lab6.runs/clk_wiz_0_synth_1/clk_wiz_0_sim_netlist.v e:/xilinx/lab6/lab6.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force E:/xilinx/lab6/lab6.runs/clk_wiz_0_synth_1/clk_wiz_0_sim_netlist.vhdl e:/xilinx/lab6/lab6.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir E:/xilinx/lab6/lab6.ip_user_files/ip/clk_wiz_0]} {
  catch { 
    file copy -force e:/xilinx/lab6/lab6.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.v E:/xilinx/lab6/lab6.ip_user_files/ip/clk_wiz_0
  }
}

if {[file isdir E:/xilinx/lab6/lab6.ip_user_files/ip/clk_wiz_0]} {
  catch { 
    file copy -force e:/xilinx/lab6/lab6.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.vhdl E:/xilinx/lab6/lab6.ip_user_files/ip/clk_wiz_0
  }
}
