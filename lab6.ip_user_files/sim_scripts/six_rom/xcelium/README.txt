...
#
# Generated by export_simulation on Fri May 03 00:03:42 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './six_rom.sh' script.

./six_rom.sh -reset_run
...
./six_rom.sh -noclean_files

For more information on the script, please type './six_rom.sh -help'.
