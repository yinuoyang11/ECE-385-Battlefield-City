...
#
# Generated by export_simulation on Sat Apr 20 22:26:17 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './red_brick_rom.sh' script.

./red_brick_rom.sh -reset_run
...
./red_brick_rom.sh -noclean_files

For more information on the script, please type './red_brick_rom.sh -help'.
