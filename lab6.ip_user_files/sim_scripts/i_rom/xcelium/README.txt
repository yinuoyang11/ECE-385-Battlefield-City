...
#
# Generated by export_simulation on Tue Apr 30 12:49:49 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './i_rom.sh' script.
...
./i_rom.sh -noclean_files

For more information on the script, please type './i_rom.sh -help'.
