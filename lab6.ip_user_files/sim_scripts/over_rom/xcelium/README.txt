...
#
# Generated by export_simulation on Fri May 03 08:10:08 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './over_rom.sh' script.

./over_rom.sh -reset_run
...
./over_rom.sh -noclean_files

For more information on the script, please type './over_rom.sh -help'.
