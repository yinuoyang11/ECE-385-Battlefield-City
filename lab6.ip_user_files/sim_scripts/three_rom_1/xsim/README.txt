...
#
# Generated by export_simulation on Fri May 03 13:22:29 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './three_rom.sh' script.

./three_rom.sh -reset_run
...
./three_rom.sh -noclean_files

For more information on the script, please type './three_rom.sh -help'.
