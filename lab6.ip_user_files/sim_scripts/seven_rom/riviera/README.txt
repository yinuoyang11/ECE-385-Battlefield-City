...
#
# Generated by export_simulation on Fri May 03 00:05:53 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './seven_rom.sh' script.

./seven_rom.sh -reset_run
...
./seven_rom.sh -noclean_files

For more information on the script, please type './seven_rom.sh -help'.
