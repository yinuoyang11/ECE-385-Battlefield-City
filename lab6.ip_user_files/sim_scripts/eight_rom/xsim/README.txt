...
#
# Generated by export_simulation on Fri May 03 00:07:17 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './eight_rom.sh' script.

./eight_rom.sh -reset_run
...
./eight_rom.sh -noclean_files

For more information on the script, please type './eight_rom.sh -help'.
