...
#
# Generated by export_simulation on Thu Apr 18 19:38:55 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './tank3_rom.sh' script.

./tank3_rom.sh -reset_run
...
./tank3_rom.sh -noclean_files

For more information on the script, please type './tank3_rom.sh -help'.
