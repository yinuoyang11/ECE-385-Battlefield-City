...
#
# Generated by export_simulation on Fri May 03 13:17:19 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './zero_rom.sh' script.

./zero_rom.sh -reset_run
...
./zero_rom.sh -noclean_files

For more information on the script, please type './zero_rom.sh -help'.
