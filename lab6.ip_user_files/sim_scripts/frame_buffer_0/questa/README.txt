...
#
# Generated by export_simulation on Fri Apr 19 16:02:54 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './frame_buffer_0.sh' script.

./frame_buffer_0.sh -reset_run
...
./frame_buffer_0.sh -noclean_files

For more information on the script, please type './frame_buffer_0.sh -help'.
